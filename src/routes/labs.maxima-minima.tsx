...
function Page() {
  return (
    <LabShell title="Maxima Minima" subtitle="Interactive laboratory.">
      <div className="pl-card pl-soft-shadow p-8 text-center">
        <div className="text-sm text-muted-foreground">This laboratory is part of the PrayoLab Maxima Minima module.</div>
