...
function Page() {
  return (
    <LabShell title="Differential Equations" subtitle="Interactive laboratory.">
      <div className="pl-card pl-soft-shadow p-8 text-center">
        <div className="text-sm text-muted-foreground">This laboratory is part of the PrayoLab Differential Equations module.</div>
