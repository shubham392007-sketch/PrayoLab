...
export const Route = createFileRoute("/about")({
  head: () => ({ meta: [{ title: "About — PrayoLab" }, { name: "description", content: "About · PrayoLab interactive engineering mathematics laboratory." }] }),
  component: Page,
});
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-5xl px-5 py-20">
        <div className="pl-chip mb-5">About</div>
