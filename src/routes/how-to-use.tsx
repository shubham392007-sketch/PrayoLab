...
export const Route = createFileRoute("/how-to-use")({
  head: () => ({ meta: [{ title: "How To Use — PrayoLab" }, { name: "description", content: "How To Use · PrayoLab interactive engineering mathematics laboratory." }] }),
  component: Page,
});
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-5xl px-5 py-20">
        <div className="pl-chip mb-5">How To Use</div>
        <h1 className="text-4xl md:text-5xl font-semibold tracking-tight">How To Use</h1>
