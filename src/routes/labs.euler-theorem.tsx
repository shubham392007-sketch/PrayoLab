...
function Page() {
  return (
    <LabShell title="Euler Theorem" subtitle="Interactive laboratory.">
      <div className="pl-card pl-soft-shadow p-8 text-center">
        <div className="text-sm text-muted-foreground">This laboratory is part of the PrayoLab Euler Theorem module.</div>
